        ...
        <div className="container mx-auto max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-center neon-text mb-2">
              <Trophy className="inline w-7 h-7 text-neon-orange mr-2" />
          ...
          {myScores && (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-display text-sm font-bold text-foreground">Your Scores — {myScores.name}</h3>
              ...
              {myScores.quiz.some(q => q > 0) && (
                <div className="mt-3 flex gap-2">
                  {myScores.quiz.map((q, i) => (
                    <span key={i} className="text-xs font-mono-code text-muted-foreground glass-card px-2 py-1">
                      A{i + 1}: {q}
                    </span>
                  ))}
                </div>
              ...
              {board.map((entry, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-3 text-[10px] font-mono-code text-muted-foreground">
